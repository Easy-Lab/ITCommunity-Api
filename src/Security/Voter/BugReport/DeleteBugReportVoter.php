...
class DeleteBugReportVoter extends Voter
{
    public const CAN_DELETE_BUG_REPORT = 'CAN_DELETE_BUG_REPORT';
    ...
    protected function supports($attribute, $subject)
    {
        ...
        return self::CAN_DELETE_BUG_REPORT === $attribute && ($subject instanceof BugReport || null === $subject);
    }
