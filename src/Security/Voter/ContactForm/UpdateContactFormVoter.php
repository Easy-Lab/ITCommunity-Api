...
class UpdateContactFormVoter extends Voter
{
    public const CAN_UPDATE_CONTACT_FORM = 'CAN_UPDATE_CONTACT_FORM';
    ...
    protected function supports($attribute, $subject)
    {
        ...
        return self::CAN_UPDATE_CONTACT_FORM === $attribute && ($subject instanceof ContactForm || null === $subject);
    }
